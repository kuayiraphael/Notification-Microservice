  ...
  async sendCheckoutEmail(recipientEmail, orderId, items, amount) {
    ...
    try {
      ...
      const mail = await transporter.sendMail({
        from: '"MultiVendorApplication" <tinacity111@gmail.com>',
        to: recipientEmail,
        subject: "Checkout created",
        html: `<h3>Dear Sir/Madam, you have created a checkout foor ${amount} dollars. Your order id is ${orderId} for the items: ${itemsBought}. If this was not done by you contact our customer support. Thank you </h3>`,
      });
    ...
    let emailContent = `<h3>Dear Sir/Madam , you have created a checkout foor ${amount} dollars. Your order id is ${orderId} for the items: ${itemsBought}. If this was not done by you contact our customer support</h3>`;
